...
export default function BoxCard(props){
    ...
    return (
        ...
        <div className="flex flex-col gap-5 justify-start items-center w-[30vw] border-slate-400 border-2 text-center py-5 flex-wrap">
            <a className="font-martian-mono text-2xl">{props.label}</a>
            <img src ={props.imageLink} className="w-40 h-40"></img>
